...
@section('content')
    <div class="header">
        <div class="cont-header container-fluid">
            ...
            <div class="cont-user">
                @guest
                    <router-link class="me-2 text-black fw-bold rounded-pill border-dark ms_btn_navbar" to='/login' exact>
                        Login
                    </router-link>
                    <router-link to='/register' class="text-black fw-bold rounded-pill border-dark ms_btn_navbar">Register
                    </router-link>
                @endguest
                @auth
                    <router-link to='/userApartments' class="border-dark me-3 principal ms_btn_navbar">Your Apartments
                    </router-link>
