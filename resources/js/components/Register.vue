            ...
            <div class="col-md-8 col-lg-8 col-sm-8">
                <div class="card border-danger">
                    ...
                    <div class="card-body text-center">
                        <form action="" @submit.prevent="saveForm" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="row mb-3">
                                <label for="email" class="col-md-4 col-form-label text-md-end text-sm-center">Email <span
                                        class="text-danger lead">&#42;</span> </label>

                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control " name="email" v-model="modelEmail"
                                        autocomplete="email">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control" name="password"
                                        v-model="modelPassword" autocomplete="new-password">
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Confirm Password
                                    <span class="text-danger lead">&#42;</span></label>

                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control"
                                        name="password_confirmation" v-model="modelPasswordConf"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" v-model="modelName"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text" class="form-control" name="surname"
                                        v-model="modelSurname" autocomplete="surname" autofocus>

                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="date_of_birth" class="col-md-4 col-form-label text-md-end">Date of birth <span
                                        class="text-danger lead">&#42;</span></label>

                                <div class="col-md-6">
                                    <input id="date_of_birth" type="date" class="form-control" name="date_of_birth"
                                        v-model="modelDate" autocomplete="date_of_birth" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control" name="description"
                                        v-model="modelDescription" autocomplete="description" autofocus>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="avatar" class="col-md-4 col-form-label text-md-end">Avatar image</label>

                                <div class="col-md-6">
                                    <input id="avatar" type="file" class="form-control" name="avatar"
                                        v-on:change="onImageChange" autocomplete="avatar" autofocus>
                                </div>
                            </div>
