    ...
    <div class="container text-center">
        ...
        <div class="mb-3">
            <form action=""
                ...
                <!-- added images form -->
                <label for="addedImage"
                    class="ms_label_smartphone d-block d-md-none">Other images:</label>
                <!-- label che compare nei piccoli schermi -->
                <div class="ms_ctn_input input-group mb-3">
                    <label class="ms_label_bg input-group-text d-none d-md-block"
                        id="basic-addon1"
                        for="addedImage">Other
                        images : </label>
                    <input type="file"
                        ref="file"
                        multiple="multiple"
        ...
        createApartment() {
            ...
            axios.post("/api/apartments", formData, config)
                .then(res => {
                    ...
                    if (this.modelDescription.length > 350) {
                        this.errors.push("The description must not be greater than 350 characters")
                    }
                    if (!this.modelPrice) {
